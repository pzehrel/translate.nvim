---@class TranslateMarkdownModule
local M = {}

---@param target string[]
---@param value TranslateHoverContents|nil
---@return nil
...
---@param contents TranslateHoverContents
---@return string
...
---@param responses table<integer|string, TranslateLspResponse|TranslateHoverResult>
---@return string
